...
public class ModEventBus {
    ...
    static void onModConstruct(FMLConstructModEvent event) {
        ...
        RCTMod.init(ModRegistries.LootItemConditions.LEVEL_RANGE, ModRegistries.LootItemConditions.DEFEAT_COUNT, CobblemonHandler::getPlayerLevel, CobblemonHandler::getActivePokemon, CobblemonHandler::makeBattle, clientConfig, () -> null, serverConfig);
    }
